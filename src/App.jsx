...
import { FaShoppingCart, FaInstagram, FaTwitter, FaPinterest } from 'react-icons/fa';
    ...
    <header className="header">
      <div className="flex-left">
        <Link to="/" className="logo">
          <span className="logo-icon"><MdOutlineLocalFlorist /></span>
          Botanica
        </Link>
        <nav className="nav">
          <Link to="/">Home</Link>
...
function Landing() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url(https://images.unsplash.com/photo-1470058869958-2a77ade41c02?auto=format&fit=crop&w=1400&q=80)",
      }}
    >
      <div className="landing-content">
        <h1 className="landing-title">Elevate Your Space with <span className="accent-text">Botanica</span></h1>
        <p className="landing-text">
          Discover our exquisite collection of premium plants, thoughtfully curated to bring life and beauty to your home
        </p>
        <button onClick={() => navigate("/products")} className="button">
            Explore Collection <span className="material-symbols-rounded">local_florist</span>
          </button>
      </div>
  ...
  return (
    <div className="product-card">
      ...
      <div className="product-details">
        ...
        <p className="product-description">Beautiful premium quality plant</p>
...
function ProductList() {
  ...
  return (
    <div className="container">
      <h2 className="section-title">Curated <span className="accent-text">Collections</span></h2>
      {categories.map((cat) => (
  ...
  return (
    <div className="container">
      <h2 className="section-title">
        ...
        Your <span className="accent-text">Botanical Collection</span>
      </h2>
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <p className="footer-text">
            Elevate your space with our premium botanical collection. Each plant is carefully selected to bring beauty, tranquility, and life to your home.
          </p>
          <div className="social-icons">
            <a href="#" aria-label="Instagram"><FaInstagram /></a>
            <a href="#" aria-label="Twitter"><FaTwitter /></a>
            <a href="#" aria-label="Pinterest"><FaPinterest /></a>
            <a href="#" aria-label="YouTube"><span className="material-symbols-rounded">smart_display</span></a>
          </div>
          <p className="copyright">© {new Date().getFullYear()} Botanica. All rights reserved.</p>
        </div>
      </footer>
    </Router>
  );
